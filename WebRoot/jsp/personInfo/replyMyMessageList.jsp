...
<body class="page-header-fixed">
					...
					<div class="span12">
						<div class="portlet box light-grey">
							...
							<div class="portlet-title">						
								<div class="caption"><i class="icon-globe"></i>回复我的</div>
							</div>
								...
								<div class="pull-right">
									...
									<ul>	
										...
										<c:if test="${messageList.pc > 1 }">						
											<li>
						            			  <a href="<%=path%>/message/getReplyMyMessageList?pc=${messageList.pc-1}&id=${isLogin.id}" aria-label="Previous">
										...
										<c:forEach var="i" begin="${begin }" end="${end }">
											<c:choose>
												...
												<c:otherwise>
												 <li><a href="<%=path%>/message/getReplyMyMessageList?pc=${i}&id=${isLogin.id}">${i }</a></li>
												</c:otherwise>
											</c:choose>
										</c:forEach>        
							            <c:if test="${messageList.pc < messageList.tp }">															
											<li>
					             			 <a href="<%=path%>/message/getReplyMyMessageList?pc=${messageList.pc+1}&id=${isLogin.id}" aria-label="Next">
	...
	<script src="<%=path%>/media/js/personInfo/replyMyMessageList.js" type="text/javascript"></script>  
