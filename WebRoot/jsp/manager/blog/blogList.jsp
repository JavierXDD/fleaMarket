					...
					<div class="span12">
						<div class="portlet box light-grey">
							...
							<div class="portlet-title">						
								<div class="caption"><i class="icon-globe"></i>交易信息列表</div>
							</div>
										...
										<c:forEach items="${blogList.beanList }" var="blogList" varStatus="status" >										
											<tr class="odd gradeX">
												...
												<td>
													...
													<a href="<%=path %>/blog/closeBlog?id=${blogList.id}" class="btn mini blue icn-only" title="禁用"><i class="halflings-icon white remove"></i></a>
												</td>										
											</tr>
										</c:forEach>
									</tbody>
