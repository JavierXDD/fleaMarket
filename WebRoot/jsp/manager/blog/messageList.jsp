...
<body class="page-header-fixed">
										...
										<c:forEach items="${messageList.beanList }" var="messageList" varStatus="status" >										
											<tr class="odd gradeX">
												...
												<td>
													...
													<a href="<%=path %>/message/managerDeleteMessage?id=${messageList.id}" class="btn mini blue icn-only" title="删除"><i class="halflings-icon white remove "></i></a>
												</td>										
											</tr>
										</c:forEach>
									</tbody>
								...
								<div class="pull-right">
									...
									<ul>	
										...
										<c:if test="${messageList.pc > 1 }">						
											<li>
						            			  <a href="<%=path%>/message/getManagerMessageList?pc=${messageList.pc-1}" aria-label="Previous">
										...
										<c:forEach var="i" begin="${begin }" end="${end }">
											<c:choose>
												...
												<c:otherwise>
												 <li><a href="<%=path%>/message/getManagerMessageList?pc=${i}">${i }</a></li>
												</c:otherwise>
											</c:choose>
										</c:forEach>        
							            <c:if test="${messageList.pc < messageList.tp }">															
											<li>
					             			 <a href="<%=path%>/message/getManagerMessageList?pc=${messageList.pc+1}" aria-label="Next">
										...
										<div class="row-fluid">
											<div class="control-group span12" >
												...
												<div class="controls span10">
													...
													<textarea id="message_text" name="text" class="span12 m-wrap" rows="8"></textarea>		
												</div>
											</div>									
										</div>
									</form>
	...
	<script src="<%=path%>/media/js/manager/blog/managerMessageList.js" type="text/javascript"></script>  
