		...
		<div class="page-content">
			...
			<div class="container-fluid">
				...
				<div class="row-fluid">
					...
					<div class="span12"> 
						...
						<ul class="breadcrumb">
							...
							<li><a href="<%=path%>/toManagerIndex">后台管理首页 </a></li>
				...
				<div id="dashboard">
					...
					<div class="row-fluid">
						<div class="span1"></div>
						<div class="responsive" data-tablet="span5" data-desktop="span5">
							<div class="dashboard-stat blue">
								...
								<a class="more" href="<%=path%>/user/toAdminList">
						...
						<div class="responsive" data-tablet="span5" data-desktop="span5">
							<div class="dashboard-stat green">
								...
								<div class="details">
									<div class="number">网站管理</div>
									<div class="desc">首页、板块、细类管理</div>
								</div>
								<a class="more" href="<%=path%>/indexPic/toIndexPicList">
								进入 <i class="m-icon-swapright m-icon-white"></i>
								</a>                 
							</div>
						</div>
					...
					<div class="row-fluid">
						...
						<div class="responsive" data-tablet="span5" data-desktop="span5">
							<div class="dashboard-stat purple">
								...
								<div class="details">
									<div class="number">交易信息管理</div>
									<div class="desc">交易信息审核、管理、评论管理</div>
								</div>
								<a class="more" href="<%=path%>/blog/toUncheckBlogList">
								进入 <i class="m-icon-swapright m-icon-white"></i>
								</a>                 
							</div>
						</div>
						...
						<div class=" responsive" data-tablet="span5" data-desktop="span5">
							<div class="dashboard-stat yellow">
								...
								<div class="details">
									<div class="number">统计分析</div>
									<div class="desc">用户、交易信息、评论信息统计分析</div>
								</div>
								<a class="more" href="<%=path%>/toUserAnalysis">
								进入 <i class="m-icon-swapright m-icon-white"></i>
								</a>                 
							</div>
						</div>
