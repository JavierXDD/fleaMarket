			...
			<div class="container-fluid">
				...
				<div class="portlet box blue">
					...
					<div class="portlet-title">
						<div class="caption"><i class="icon-reorder"></i>管理员详情页</div>
					</div>
					...
					<div class="portlet-body form">
						...
						<div class="form-horizontal form-view">
								...
								<div class="span6 ">
									...
									<div class="control-group">
										...
										<div class="controls">
											...
											<span class="text">${admin.nickname}</span>
								...
								<div class="span6 ">
									...
									<div class="control-group">
										...
										<div class="controls">
											...
											<span class="text">${admin.sex }</span> 
								...
								<div class="span6 ">
									...
									<div class="control-group">
										...
										<div class="controls">
											...
											<span class="text bold">${admin.telephone }</span>
							...
							<div class="row-fluid">
								...
								<div class="span6 ">
									...
									<div class="control-group">
										...
										<div class="controls">
											...
											<span class="text bold">${admin.email }</span>
								...
								<div class="span6 ">
									...
									<div class="control-group">
										...
										<div class="controls">
											<c:if test="${admin.isManager eq 0}">
												<span class="text bold ">会员</span>
											</c:if>
											<c:if test="${admin.isManager eq 1 }">
												<span class="text bold ">管理员</span>
											</c:if>	
											<c:if test="${admin.isManager eq 2 }">
								...
								<div class="span6 ">
									...
									<div class="control-group">
										...
										<div class="controls">
											...
											<span class="text bold">${admin.createTime }</span>
							...
							<div class="form-actions">
								...
								<button type="button" onclick="location='<%=path %>/user/toUserEdit?id=${admin.id }'" class="btn blue"><i class="icon-pencil"></i> 编辑</button>
