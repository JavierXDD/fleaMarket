...
<body class="page-header-fixed">
			...
			<div class="container-fluid">
					...
					<div class="span12">						
						...
						<ul class="breadcrumb">
							...
							<li>
								...
								<a href="<%=path%>/user/toAdminList">用户管理</a>

								<i class="icon-angle-right"></i>

							</li>

							<li><a href="<%=path%>/user/toAdminList">管理员管理</a></li>
				...
				<div class="portlet box green">
					...
					<div class="portlet-title">
						<div class="caption"><i class="icon-reorder"></i>个人信息编辑</div>
					</div>
					...
					<div class="portlet-body form">
						...
						<form action="<%=path %>/user/saveOrUpdateUser" id="userEditForm" method="post"  class="form-horizontal">
								...
								<div class="span6 ">
									...
									<div class="control-group">
										...
										<div class="controls">
											...
											<input type="text" class="m-wrap span12" id="userEdit_nickname" name="nickname" placeholder="${admin.nickname }" value="${admin.nickname }">
								...
								<div class="span6 ">
									...
									<div class="control-group ">
										...
										<div class="controls">
											...
											<input type="text" class="m-wrap span12" name="name" placeholder="${admin.name}" value="${admin.name }">
									...
									<div class="control-group">
										...
										<div class="controls">
											...
											<select class="m-wrap span12" name="sex">
												<c:choose>
													<c:when test="${admin.sex eq '男' }">
														<option value="男" selected = "selected">男</option>
														<option value="女">女</option>																								
													</c:when>											
													<c:when test="${admin.sex eq '女' }">
								...
								<div class="span6 ">
									...
									<div class="control-group">
										...
										<div class="controls">
											...
											<input type="text" class="m-wrap span12" id="telephone" name="telephone" placeholder="${admin.telephone }" value="${admin.telephone }">
							...
							<div class="row-fluid">
								...
								<div class="span6 ">
									...
									<div class="control-group">
										...
										<div class="controls">
											<input type="text" class="m-wrap span12" id="email"  name="email" placeholder="${admin.email }" value="${admin.email }">
								...
								<div class="span6">
									<div class="control-group">
										...
										<div class="controls">
											<c:if test="${isLogin.isManager eq 1 }">
											...
											<c:if test="${isLogin.isManager eq 2 }">
												<select class="m-wrap span12" name="isManager">				
													<c:choose>
														<c:when test="${admin.isManager eq 0 }">
															<option value="0" selected = "selected">会员</option>
															<option value="1">管理员</option>														
														</c:when>
														<c:when test="${admin.isManager eq 1 }">
							...
							<div class="row-fluid">
								<div class="span6 ">		
									<div class="control-group">		
										...
										<div class="controls">												
											<input type="text" class="m-wrap span12" readonly="readonly" placeholder="${admin.createTime }" name="createTime" value="${admin.createTime }"/>
										</div>
									</div>		
								</div>		
								<div class="span6 ">
									<div class="control-group">		
										<label class="control-label"><i style="color:red">* </i>启用状态</label>
										<div class="controls">
															
												<c:if test="${admin.isUse eq 0 }">
													<input type="text" class="m-wrap span12" readonly="readonly" value="已启用" >
	...
	<script src="<%=path%>/media/js/manager/user/userEdit.js" type="text/javascript"></script>  
