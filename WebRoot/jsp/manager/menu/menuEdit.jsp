...
<body class="page-header-fixed">
			...
			<div class="container-fluid">
					...
					<div class="span12">						
						...
						<ul class="breadcrumb">
							...
							<li>
								...
								<a href="<%=path%>/user/toAdminList">网站管理</a>

								<i class="icon-angle-right"></i>

							</li>

							<li><a href="<%=path%>/user/toAdminList">板块管理</a></li>
				...
				<div class="portlet box green">
					...
					<div class="portlet-title">
						<div class="caption"><i class="icon-reorder"></i>板块信息编辑</div>
					</div>
					...
					<div class="portlet-body form">
						...
						<form action="<%=path %>/menu/saveOrUpdateMenu" id="menuEditForm" method="post"  class="form-horizontal">
						<input type="hidden" id="menuId" name="id" value="${menu.id }">
						<input type="hidden" id="parentsId" name="parentsId" value="0">
							<h3 class="form-section">基本信息</h3>							

							<div class="row-fluid">
								<div class="span6 ">
									<div class="control-group">
										<label class="control-label"><i style="color:red">* </i>板块名</label>
										<div class="controls">
											<input type="text" class="m-wrap span12" id="name" name="name" placeholder="${menu.name }" value="${menu.name}">
								...
								<div class="span6 ">
									<div class="control-group">
										<label class="control-label"><i style="color:red">* </i>板块图标</label>
										<div class="controls">											
											<input type="text" class="m-wrap span11" id="thumbnailUrl" name="thumbnailUrl"  value="${menu.thumbnailUrl}">
											<i class="${menu.thumbnailUrl }"></i>
											<span class="help-block" style="color:red;" style="color:red;" id="userEdit_thumbnailUrl_help"></span>
										</div>
									</div>
								</div>
							</div>
							...
							<div class="row-fluid">
								...
								<div class="span6 ">
									...
									<div class="control-group">
										...
										<label class="control-label"><i style="color:red">* </i>板块链接</label>

										<div class="controls">
											<input type="text" class="m-wrap span12" id="url" name="url" placeholder="${menu.url }" value="${menu.url }">
											<span class="help-block" style="color:red;" id="url_help"></span>
										</div>
								...
								<div class="span6 ">
									...
									<div class="control-group">
										...
										<label class="control-label">板块顺序号</label>

										<div class="controls">
											<c:if test="${empty menu.id }">
												<input type="text" class="m-wrap span12" id="menuOrder" name="menuOrder" readonly="readonly" value="${menuMaxOrder }">											
											</c:if>
											<c:if test="${not empty menu.id }">
												<input type="text" class="m-wrap span12" id="menuOrder" name="menuOrder" readonly="readonly" value="${menu.menuOrder }">											
											</c:if>											
							...
							<div class="row-fluid">
									...
									<div class="control-group">
										...
										<div class="controls">
											<select class="m-wrap span12" id="isUse" name="isUse">
												<c:choose>
													<c:when test="${menu.isUse eq 0 }">
														<option value="0" selected = "selected">启用</option>
														<option value="1">禁用</option>																								
													</c:when>											
													<c:when test="${menu.isUse eq 1 }">
								...
								<div class="span6">
									<div class="control-group">
										<label class="control-label"><i style="color:red">* </i>是否展示在首页</label>
										<div class="controls">
											<select class="m-wrap span12" name="isShow" id="isShow">
												<c:choose>
													<c:when test="${menu.isShow eq 0 }">
														<option value="0" selected = "selected">展示</option>
														<option value="1">不展示</option>																								
													</c:when>											
													<c:when test="${menu.isShow eq 1 }">
														<option value="0">展示</option>
														<option value="1" selected = "selected">不展示</option>																								
													</c:when>
													<c:otherwise>
														<option value="0">展示</option>
														<option value="1">不展示</option>												
							...
							<div class="row-fluid">
								<div class="span12 ">		
									<div class="control-group">		
										...
										<div class="controls">	
										<script id="UEcontent" name="text" id="text" type="text/plain" >${menu.text }</script>																
										...
										<div class="controls">
											<div class="fileupload fileupload-new" data-provides="fileupload">
												...
												<div class="fileupload-new thumbnail" style="width: 200px; height: 150px;">
													...
													<img src="<%=path%>/${menu.picUrl }" alt="" />

												</div><br>
												<input type="hidden" name="picUrl" id="picUrl" value="${menu.picUrl }"/>
												<a style="width: 210px;" href="javascript:void(0);" onclick="menuPic()" class="btn green btn-block">上传图片<i class=" m-icon-white"></i></a>
							...
							<div class="form-actions">
								<button type="submit" id="save_menu" class="btn blue"><i class="icon-ok"></i>保存</button>
					...
					<!-- 模态框（禁用用户） -->
					<div class="modal fade" id="menuPicModal" tabindex="-1" role="dialog" aria-labelledby="menuPicLabel" aria-hidden="true">
					    <div class="modal-dialog">
					        <div class="modal-content">
					            ...
					            <div class="modal-body">
									<form id="menuPicForm"  action="<%=path%>/menu/upMenuPic" method="post" class="form-horizontal" enctype="multipart/form-data" >
										<div class="row-fluid">
											<div class="control-group span10" >
												<label class="control-label">上传板块配图</label>		
													
												<div class="controls">											 	
													<input name="menuPic" id="menuPic"  class=" btn btn-theme" type="file" accept = 'image/*'>
													<input name="menuPic_menuId" type="hidden" id="menuPic_menuId" >
													<input name="menuPic_name" type="hidden" id="menuPic_name" >
													<input name="menuPic_url" type="hidden" id="menuPic_url" >
													<input name="menuPic_menuOrder" type="hidden" id="menuPic_menuOrder" >
													<input name="menuPic_isUse" type="hidden" id="menuPic_isUse" >
													<input name="menuPic_isShow" type="hidden" id="menuPic_isShow" >
													<input name="menuPic_text" type="hidden" id="menuPic_text" >
													<input name="menuPic_thumbnailUrl" type="hidden" id="menuPic_thumbnailUrl" >
													<span class="help-block" style="color:red;" style="color:red;" id="menuPic_help"></span>	
												</div>
											</div>									
										</div>
									</form>
					            ...
					            <div class="modal-footer">            
					                <button type="button " id="menuPic_submit" class="btn blue btn-primary">提交</button>
	...
	<script type="text/javascript" charset="utf-8" src="<%=path%>/media/ueditor/lang/zh-cn/zh-cn.js"></script>
 	<script type="text/javascript" charset="utf-8" src="<%=path%>/media/js/manager/menu/menuEdit.js"></script>
	<script>
