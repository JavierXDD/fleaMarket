...
<body class="page-header-fixed">
						...
						<div class="portlet box light-grey">
							...
							<div class="portlet-title">
								...
								<div class="btn-group pull-right">
									...
									<button onclick="location='<%=path %>/menu/toMenuEdit'" class="btn green">
										...
										<c:forEach items="${menuList.beanList }" var="menuList" varStatus="status" >										
											<tr class="odd gradeX">
												...
												<td>
													...
													<a href="<%=path %>/menu/toMenuEdit?id=${menuList.id}" class="btn mini blue icn-only" title="编辑"><i class="halflings-icon white pencil "></i></a>
													<c:if test="${menuList.isUse eq 0}">
														<a href="javascript:void(0);" onclick="forbiddenMenu('${menuList.id}')"  class="btn mini red icn-only" title="禁用"><i class="halflings-icon white ban-circle"></i></a>																																																												
													</c:if>
													<c:if test="${menuList.isUse eq 1}">
														<a href="javascript:void(0);" onclick="usingMenu('${menuList.id}')"  class="btn mini red icn-only" title="启用"><i class="halflings-icon white ok-circle"></i></a>																																																											
													</c:if>
												</td>
											</tr>
										</c:forEach>
	...
	<script src="<%=path%>/media/js/app.js" type="text/javascript"></script>
 	<script src="<%=path%>/media/js/manager/menu/menuList.js" type="text/javascript"></script>
