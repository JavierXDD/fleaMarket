			...
			<div class="container-fluid">
				...
				<div class="portlet box blue">
					...
					<div class="portlet-title">
						<div class="caption"><i class="icon-reorder"></i>板块详情页</div>
					</div>
					...
					<div class="portlet-body form">
						...
						<div class="form-horizontal form-view">
							...
							<div class="row-fluid">
								<div class="span6 ">
									<div class="control-group">
										<label class="control-label" for="nickname">板块名</label>
										<div class="controls">
								...
								<div class="span6 ">
									<div class="control-group">
										<label class="control-label" for="nickname">板块图标</label>
										<div class="controls">
							...
							<div class="row-fluid">
								...
								<div class="span6 ">
									...
									<div class="control-group">
										...
										<div class="controls">
											...
											<span class="text">${menu.menuOrder }</span> 
								...
								<div class="span6 ">
									...
									<div class="control-group">
										...
										<label class="control-label">板块链接</label>

										<div class="controls">

											<span class="text bold">${menu.url }</span>
							...
							<div class="row-fluid">
								...
								<div class="span6 ">
									...
									<div class="control-group">
										...
										<div class="controls">
											<c:if test="${menu.isUse eq 0}">
												<span class="text bold ">已启用</span>
											</c:if>
											<c:if test="${menu.isUse eq 1}">
								...
								<div class="span6 ">
									...
									<div class="control-group">
										...
										<label class="control-label">是否展示在首页</label>

										<div class="controls">
											<c:if test="${menu.isShow eq 0}">
												<span class="text bold ">展示</span>
											</c:if>
											<c:if test="${menu.isShow eq 1 }">
												<span class="text bold ">不展示</span>
											</c:if>											
										</div>
							...
							<div class="row-fluid">
								<div class="span12 ">
									...
									<div class="control-group">
										...
										<label class="control-label" for="name">板块描述</label>
							...
							<div class="form-actions">
								...
								<button type="button" onclick="location='<%=path %>/menu/toMenuEdit?id=${menu.id }'" class="btn blue"><i class="icon-pencil"></i> 编辑</button>
