...
<body class="page-header-fixed">
					...
					<div class="span12">
						<div class="portlet box light-grey">
							...
							<div class="portlet-title">
								<div class="caption"><i class="icon-globe"></i>一级菜单列表</div>								
							</div>
									...
									<tbody>
										<c:forEach items="${menuList.beanList }" var="menuList" varStatus="status" >										
											<tr class="odd gradeX">
												...
												<td>
													<a href="<%=path%>/menu/toSonMenuList?pId=${menuList.id}" class="btn mini purple  icn-only" title="编辑子菜单"><i class="halflings-icon white list "></i></a>														
												</td>
											</tr>
										</c:forEach>
									</tbody>
	...
	<script src="<%=path%>/media/js/app.js" type="text/javascript"></script>
 	<script src="<%=path%>/media/js/manager/menu/sonMenuIndex.js" type="text/javascript"></script>
