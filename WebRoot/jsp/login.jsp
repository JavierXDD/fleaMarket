...
<head>
	...
	<link href="<%=path%>/media/css/slide-unlock.css" rel="stylesheet" type="text/css"/>
...
<body class="login">
	...
	<div class="content">
		...
		<form class="form-vertical login-form" id="loginForm"  action="#">
			...
			<div class="alert alert-error2 hide">
				...
				<span>登录失败,该用户已被禁用,请与管理员联系！</span>
			...
			<div class="control-group">
				...
				<div class="controls">
					...
					<div class="input-icon left">
						...
						<input class="m-wrap placeholder-no-fix" type="text" placeholder="用户名" name="nickname"/>
			...
			<div class="create-account">
				<p>
					还没有账号?&nbsp; 
					<a href="javascript:;" id="register-btn" class="">创建一个新用户</a>
				</p>
			</div>
		...
		<form class="form-vertical register-form" method="post" action="<%=path%>/user/register">
			...
			<div class="control-group">
				...
				<div class="controls">
					...
					<div class="input-icon left">
						...
						<input class="m-wrap placeholder-no-fix" type="text" placeholder="用户名" id="register_nickname" name="nickname"/>
			...
			<div class="control-group">
				...
				<div class="controls">
					...
					<input type="checkbox" name="tnc"/> 我已阅读并同意遵守相关法律法规</a>
	...
	<script src="<%=path%>/media/js/jquery.slideunlock.js" type="text/javascript"></script>      
